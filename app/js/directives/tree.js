...
four51.app.directive('subcategorytree', function() {
	var obj = {
		restrict: 'E',
		replace: true,
		scope: {
		...
		templateUrl: 'partials/subcategoryTree.html'
	};
	return obj;
});
	...
	var obj = {
		...
		link: function(scope, element) {
			if (angular.isArray(scope.node.SubCategories)) {
				element.append("<subcategorytree tree='node.SubCategories' current='current'/>");
